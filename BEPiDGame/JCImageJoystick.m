...
-(id)initWithJoystickImage:(NSString *)joystickImage baseImage:(NSString *)baseImage
{
    ...
    {
        SKTexture *texture = [SKTexture textureWithImage:[UIImage imageNamed:joystickImage]];
        self.joystick = [[SKSpriteNode alloc]initWithTexture:texture color:nil size:CGSizeMake(75, 75)];
